...
namespace AWSServerless1.Tests
{
    public class FunctionTest
    {
        ...
        public async Task TestS3EventLambdaFunction()
        {
            ...
            var bucketName = "lambda-AWSServerless1-".ToLower() + DateTime.Now.Ticks;
            var key = "text.txt";
            ...
            try
            {
                ...
                var function = new GuestUserCheck(s3Client);
                var contentType = await function.ProcessingGuestUserImageToIndexOrCheck(s3Event, null);
